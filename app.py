...
st.set_page_config(page_title="Enhanced BioAuth System", layout="wide", page_icon="🛡️")
    ...
    try:
        with st.spinner("Preparing to record..."):
            ...
            with col2:
                ...
                status_text.info("⏺️ Recording... Speak now!")
...
# Navigation
st.sidebar.title("🛡️ Enhanced BioAuth")
st.sidebar.markdown("---")
...
if user_type == "👑 Admin Panel":
    ...
    if admin_password == "Admin@123":
        ...
        st.warning("⚠️ Please log in as admin to access the admin panel")
        authentication_flow()
else:
    authentication_flow()